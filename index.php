...
<script>
  ...
  $(document).ready(function(){   //calling jquery ready function to initialise  jquery table
    $('#table1').DataTable();  
  });  

//////////////////////////display Modal Window when User clicks on edit icon//////////////////////////////////
...
// Closw modal window when the user clicks anywhere outside of the modal
